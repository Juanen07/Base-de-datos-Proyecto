<?php
// Reemplaza tus credenciales de conexión aquí
...
echo "<div align='center' style='font-weight: bold; font-size: 40px; margin-top: 30; color: white;'>Listado de Profesores</div><br>";
...
echo "<div class='link divALaDerecha'><a href=\"profesor_alta.php\" style='color: white;'>Crear nuevo registro</a></div><br><br>";
